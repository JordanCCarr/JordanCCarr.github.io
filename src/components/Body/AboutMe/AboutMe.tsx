    ...
    return (
        <div className="about-me-wrapper">
            <div className="about-text">
                ...
                <p>My technical capabilties include both backend and frontend development. <a href="https://github.com/JordanCCarr/Personal-Website">I even wrote this website myself!</a></p>
